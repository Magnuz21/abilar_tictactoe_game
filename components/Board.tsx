    ...
    <div>
      <div className="board">
        <div className=" w-[300px] md:[w-400px] rounded-lg flex items-center justify-center space-x-10">
          <div>
            {playerX
              ...
              <div className="text-white bg-gray-700 text-xl px-4 py-1 w-28 rounded-lg font-medium uppercase">
                <span className="text-[#ffbe0b] text-2xl font-bold">
                  X
                </span>
                {" "}
                Turn
              ...
              :
              <div className="text-white bg-gray-700 text-xl px-4 py-1 w-28 rounded-lg font-medium  uppercase">
                <span className=" text-[#fb5607] text-2xl  font-bold">
                  O
                </span>
                {" "}
                Turn
          ...
          <button onClick={handleRestartGame} className="group button px-2 py-1 hover:ring-4 hover:ring-cyan-300 rounded-md bg-[#ff006e] hover:bg-[#30c4bd]" >
